...
import {getPostsByCategory, PostsByCategoryInput} from '../read/get-posts-by-category'
import {removePost, RemovePostInput} from '../delete/remove-post'
import {del} from '../raw/del'
import {CommentsInput, getComments} from '../read/get-comments'
import {removeComment, RemoveCommentInput} from '../delete/remove-comment'
import {getPostsByUserId, PostsByUserIdInput} from '../read/get-posts-by-user-id'
import {getPostsByUserLike, PostsByUserLikeInput} from '../read/get-posts-by-user-like'
import {CommentsByUserIdInput, getCommentsByUserId} from '../read/get-comments-by-user-id'
import {Input, updateComment} from '../update/update-comment'
import {addLike, Input} from './add-like'
import {get} from '../raw/get'
import {removeLike, RemoveLikeInput} from '../delete/remove-like'
...
import {getAllReports} from '../read/get-all-reports'
...
export class MetadataStore {
  ...
  put<T extends Yiguana.Document>(input: Yiguana.Document) {
    return put<T>(this.operator, input)
  }

  get<T extends Yiguana.Document>(input: Yiguana.Document) {
  ...
  del<T extends Yiguana.Document>(input: Yiguana.Document) {
